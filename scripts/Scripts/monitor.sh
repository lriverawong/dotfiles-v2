...
if xrandr | grep -w "$ecobee connected"; then
    # randr --output eDP1 --mode 1600x900 --pos 0x904 --rotate normal --output DP1 --primary --mode 2560x1440 --pos 1600x364 --rotate normal --output DP2 --off --output HDMI1 --off --output HDMI2 --mode 1920x1080 --pos 4160x0 --rotate right --output VIRTUAL1 --off
    xrandr --output eDP1 --off --output DP1 --primary --mode 2560x1440 --pos 0x0 --rotate normal --output DP2 --off --output HDMI1 --off --output HDMI2 --off --output VIRTUAL1 --off
